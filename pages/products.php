            ...
            <aside class="w-full p-4 border-r-1 border-[var(--light-dark-color)] flex flex-col items-center text-center lg:max-w-[300px] lg:items-start lg:text-left">
                ...
                <ul class="flex flex-col gap-2 mt-2">
                    ...
                    if ($categoryQuery == "all") {
                        echo ("
                            <li>
                                <a href='index.php?page=products&cat=all' class='hover:text-[var(--primary-color)] text-[var(--primary-color)]'>
                                    Todos los productos
                                </a>
                            </li>
                        ");
                        ...
                        echo ("
                            <li>
                                <a href='index.php?page=products&cat=all' class='hover:text-[var(--primary-color)] text-[var(--dark-text-color)]'>
                                    Todos los productos
                                </a>
                            </li>
                        ");
                    ...
                    foreach ($categories as $category) {
                        // categoryQuery es un string, category->getId() es un int
                        if ($category->getId() == $categoryQuery) {
                            echo ("<li><a class='text-[var(--primary-color)] font-bold' href='index.php?page=products&cat=" . $category->getId() . "'>" . $category->getName() . "</a></li>");
                        } else {
