<main>
    ...
    <section class="relative">
        ...
        <div class="crafters">
            <div
                class="logo logo_background_image logo_background_image_maskImage logo_background_image_loaded">
                <div></div>
            </div>
        </div>
        <!-- Background animation -->
        <div class="background">
            <div class="sync_lines">
                <div
                    class="sync_line lazy_background_image lazy_background_image_maskImage lazy_background_image_loaded">
                    <div></div>
                </div>
